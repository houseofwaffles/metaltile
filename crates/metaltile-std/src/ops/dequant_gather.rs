...
inventory::submit! {
    BenchSpec {
        op: "dequant_gather",
        subop: "int4",
        kernel_name: "dequant_gather_int4",
        kernel_ir: dequant_gather_int4::kernel_ir_for,
...
inventory::submit! {
    BenchSpec {
        op: "dequant_gather",
        subop: "int3",
        kernel_name: "dequant_gather_int3",
        kernel_ir: dequant_gather_int3::kernel_ir_for,
        dtypes: ALL_FLOAT_DTYPES,
        tol: 0.0,
        mlx_src: None,
        mlx_pattern: None,
...
inventory::submit! {
    BenchSpec {
        op: "dequant_gather",
        subop: "int5",
        kernel_name: "dequant_gather_int5",
        kernel_ir: dequant_gather_int5::kernel_ir_for,
        dtypes: ALL_FLOAT_DTYPES,
        tol: 0.0,
        mlx_src: None,
        mlx_pattern: None,
...
inventory::submit! {
    BenchSpec {
        op: "dequant_gather",
        subop: "int6",
        kernel_name: "dequant_gather_int6",
        kernel_ir: dequant_gather_int6::kernel_ir_for,
        dtypes: ALL_FLOAT_DTYPES,
        tol: 0.0,
        mlx_src: None,
        mlx_pattern: None,
...
inventory::submit! {
    BenchSpec {
        op: "dequant_gather",
        subop: "int8",
        kernel_name: "dequant_gather_int8",
        kernel_ir: dequant_gather_int8::kernel_ir_for,
        dtypes: ALL_FLOAT_DTYPES,
        tol: 0.0,
        mlx_src: None,
        mlx_pattern: None,
