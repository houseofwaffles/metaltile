...
//!
//! Registered via `inventory::submit!` with empty `shapes` — `tile
//! bench` and `tile test` skip them today. The benches that matter
//! happen end-to-end in FFAI's `ffai bench` harness.
