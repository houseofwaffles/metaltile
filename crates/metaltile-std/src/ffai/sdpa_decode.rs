//! Naive single-Q SDPA decode with online softmax — FFAI-only port.
//!
...
//!
//! Codegen-only — mainline MLX has no template equivalent. Correctness
//! is validated end-to-end in FFAI's integration tests.
