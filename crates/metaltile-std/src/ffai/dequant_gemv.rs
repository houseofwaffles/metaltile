...
macro_rules! register_dequant_gemv {
...
// ── Element-strided body (int3, int5, int6) ───────────────────────────────
//
...
pub fn dequant_gemv_int4<T>(
    ...
    dequant_gemv_pow2_body!(4u32);
}
register_dequant_gemv!("int4", dequant_gemv_int4);
...
pub fn dequant_gemv_int8<T>(
    ...
    dequant_gemv_pow2_body!(8u32);
}
register_dequant_gemv!("int8", dequant_gemv_int8);
...
pub fn dequant_gemv_int3<T>(
    ...
    dequant_gemv_odd_body!(3u32);
}
register_dequant_gemv!("int3", dequant_gemv_int3);
...
pub fn dequant_gemv_int5<T>(
    ...
    dequant_gemv_odd_body!(5u32);
}
register_dequant_gemv!("int5", dequant_gemv_int5);
...
pub fn dequant_gemv_int6<T>(
    ...
    dequant_gemv_odd_body!(6u32);
}
register_dequant_gemv!("int6", dequant_gemv_int6);
